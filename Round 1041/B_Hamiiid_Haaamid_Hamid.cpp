...
void solve(){
    ...
    //case 1:
    // Put a wall on his left. Either break all his walls to his left
    // Or break all the walls from his nearest right
    int ans1=min(x+1,n-r+1);
    //case 2:
    //Put a wall on his right. Either break all his walls to his right
    //or break all the walls from his nearest left
    int ans2=min(l+2,n-x);
